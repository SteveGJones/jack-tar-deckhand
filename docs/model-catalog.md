...
Catalog version **1.2.0**, updated **2026-07-23**, min loader version 1.
...
| Model | Status | Roles | Resolutions | Pricing (USD) | Quirks | Aliases |
|---|---|---|---|---|---|---|
| `mlx/flux2-klein-4b` | active | image_gen, local_draft, image_edit | 1K | $0.000 flat | mflux_metadata_sidecar_null | `flux2-klein-4b-mflux` |
| `mlx/z-image-turbo` | active | image_gen, local_draft | 1K | $0.000 flat | — | `z-image-turbo-mflux` |
| `mlx/qwen-image` | active | image_gen, local_draft, image_edit | 1K | $0.000 flat | — | `qwen-image-mflux` |
...
- **`gemini-3.1-flash-image`** — Nano Banana Flash. The '-preview' suffixed id was deprecated upstream (issue #123, verified 2026-07-15); alias retained so existing manifests and callers resolve. BENCHMARK 2026-07-17: top TECHNICAL-figure scorer of the whole field (8.70 blind, above Pro's 8.40 at 1K) — the preferred cloud tier for academic/technical figures.
...
- **`gemini-3-pro-image`** — Nano Banana Pro. '-preview' id deprecated upstream (issue #123). BENCHMARK 2026-07-17 (blind adversarial, docs/spikes/2026-07-17-mlx-model-benchmark/): at 1K, Flash MATCHED-OR-BEAT Pro on technical figures (TECH 8.70 vs 8.40) — Pro escalation is NOT required for technical/academic figures at 1K; reserve Pro for 2K/4K resolution needs or hero polish. On hero images the local ERNIE-Turbo draft beat both cloud tiers (8.75 blind) — cloud hero escalation is frequently unnecessary.
